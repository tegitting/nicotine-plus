# COPYRIGHT (C) 2020-2024 Nicotine+ Contributors# COPYRIGHT (C) 2011 quinox <quinox@users.sf.net>
#
...
from dataclasses import dataclass# Define constants for clarity and maintainability (Using powers of 2 is idiomatic)
KB_IN_BYTES = 1024
MB_IN_BYTES = KB_IN_BYTES * 1024
GB_IN_BYTES = MB_IN_BYTES * 1024
AUTO_MESSAGE_PREFIX = "[Auto-Message] "@dataclass
class ShareStats:
    ...
    private_folders: int
    total_shared: int
    locked_percent: intclass Plugin(BasePlugin):def __init__(self, *args, **kwargs):
